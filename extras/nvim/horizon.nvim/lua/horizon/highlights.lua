...
function M.setup(c)
    ...
    hi("@markup.heading", { fg = c.agnes, bold = true })
    ...
    hi("RenderMarkdownTableHead", { fg = c.agnes, bold = true })
    hi("RenderMarkdownTableRow", { fg = c.fg1 })
    ...
    hi("NeoTreeHiddenByName", { fg = c.grandmaster })
    hi("NeoTreeDotfile", { fg = c.grandmaster })
    ...
    hi("NeoTreeGitIgnored", { fg = c.grandmaster })
    ...
    hi("SnacksPickerGitStatusIgnored", { fg = c.grandmaster })
    hi("SnacksPickerHidden", { fg = c.grandmaster })
    hi("SnacksExplorerHidden", { fg = c.grandmaster })
    hi("SnacksPickerPathHidden", { fg = c.grandmaster })
